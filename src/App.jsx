  ...
  return <>
    ...
    <header className={`navigation ${menuOpen ? 'is-open' : ''}`}>
      ...
      <nav className="desktop-nav" aria-label="주요 메뉴">
        <a href="#studio">Studio</a><a href="#approach">Approach</a><a href="#spirit">Our spirit</a>
      </nav>
      ...
      {menuOpen && <nav id="mobile-menu" className="mobile-nav" aria-label="모바일 메뉴">
        ...
        <a href="#spirit" onClick={closeMenu}>Our spirit <span>03</span></a>
    ...
    <main>
      <section className="hero" id="home" ref={heroRef} onPointerMove={parallax} onPointerLeave={e => { e.currentTarget.style.setProperty('--mx','0px'); e.currentTarget.style.setProperty('--my','0px'); }}>
        ...
        <div className="hero-content">
          ...
          <a href="#studio" className="button hero-cta">렛츠펫츠 만나기 <Arrow /></a>
        </div>
      ...
      <section className="studio section-pad" id="studio">
        <div className="intro-copy">
          ...
          <p className="intro-ending" data-reveal>크게 만들기보다, 기분 좋게 남도록.</p>
        </div>
      ...
      <section className="approach" id="approach">
        <div className="section-heading" data-reveal><p className="eyebrow">02 / HOW WE MAKE</p><h2 className="display">A little thought.<br/>A lot of feeling.</h2><p>호기심은 가볍게. 만드는 마음은 깊게.</p></div>
      ...
      <section className="spirit section-pad" id="spirit">
        <div className="section-heading" data-reveal><p className="eyebrow">03 / THE LETSPETS SPIRIT</p><h2 className="display">Small studio.<br className="mobile-break"/> Big curiosity.</h2><p>한 사람이 만들지만,<br className="mobile-break"/> 가능성까지 작을 필요는 없으니까.</p></div>
